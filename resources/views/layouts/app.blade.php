    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .hero {
            ...
            border: 1px solid var(--border); border-radius: 2rem; padding: 2.2rem;
            box-shadow: 0 20px 70px rgba(17,33,31,0.08); margin-top: 1.6rem; overflow: hidden; position: relative;
        }
        .hero::before {
            content: '';
        ...
        .impact-panel {
            ...
            border: 1px solid var(--border); border-radius: 1.5rem; padding: 1.25rem;
            box-shadow: 0 16px 40px rgba(17,33,31,0.05); display: flex; gap: 1.25rem; align-items: center;
        }
        .impact-copy { flex: 2; }
        ...
        .cta-panel {
            margin-top: 2rem; display: flex; gap: 1rem; align-items: center; justify-content: space-between;
            padding: 1.25rem; border-radius: 14px; background: linear-gradient(90deg, rgba(28,127,90,0.95), rgba(18,85,63,0.95));
            color: white; box-shadow: 0 18px 50px rgba(17,33,31,0.12);
        }
        ...
        .faq-item { background: var(--panel); border: 1px solid var(--border); border-radius: 1.25rem; padding: 1.25rem; }
        ...
        .form-group input, .form-group textarea {
            width: 100%; padding: 0.75rem; border: 1px solid var(--border); border-radius: 0.75rem;
            font-family: inherit; font-size: 1rem; background: var(--panel);
        }
        .form-group textarea { resize: vertical; min-height: 120px; }
        .alert-success { padding: 1rem; border-radius: 0.75rem; background: var(--accent-soft); color: var(--accent-strong); font-weight: 600; margin-bottom: 1rem; }
